...
var getCubicArcLength = ({
  ...
  for (let i = 0;i < n; i++) {
    ...
    const xbase = mt * mt * v0x + 2 * mt * correctedT * v1x + correctedT * correctedT * v2x;
    const ybase = mt * mt * v0y + 2 * mt * correctedT * v1y + correctedT * correctedT * v2y;
...
// src/center-path.ts
var centerPath = (d, target = { x: 0, y: 0 }) => {
