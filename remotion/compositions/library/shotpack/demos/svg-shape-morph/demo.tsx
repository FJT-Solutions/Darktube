// svg-shape-morph — Shape Morph outline morphing (motion-lab final cut ported to native Remotion)
// one SVG outline smoothly morphs into another and back: both closed outlines are first resampled
// to the same point count (140 polar points), then interpolated point-by-point with inOutCubic,
// plus a slight scale breathing and hue drift in the middle of the morph for an organic, fluid feel.
...
// two shapes: same sampling point count (equivalent to morphTo's point alignment)
...
// interpolate the two outlines point-by-point by blend factor m, building the path d
...
export const SvgShapeMorph: React.FC = () => {
  ...
  // scale breathing + slow rotation during the morph
